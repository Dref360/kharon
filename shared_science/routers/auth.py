...
def validate_access_token(access_token):
    data = httpx.get(f'https://www.googleapis.com/oauth2/v1/tokeninfo?access_token={access_token}').json()
...
async def auth_google(body: CodeFlow = Body(...)):
    ...
    user_info = httpx.get("https://www.googleapis.com/oauth2/v1/userinfo",
